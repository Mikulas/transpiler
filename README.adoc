...
----
bash <(curl -sSL 'https://raw.githubusercontent.com/Mikulas/transpiler/v1.1.0/installer.sh')
----
...
curl -L 'https://github.com/Mikulas/transpiler/releases/download/v1.1.0/transpiler.phar' -o "$TARGET"
chmod a+x "$TARGET"
