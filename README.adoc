...
```
bash <(curl -sSL 'https://raw.githubusercontent.com/Mikulas/transpiler/v1.0.0/installer.sh')
```
...
curl -L 'https://github.com/Mikulas/transpiler/releases/download/v1.0.0/transpiler.phar' -o "$TARGET"
chmod a+x "$TARGET"
